           ...
           if(formData.email.trim()!==''||formData.password.trim()!==''){
            try {
                ...
                if(response.data.data.role==='admin'){
                    console.log('adin verified form role')
  ...
  return (
    <>
        ...
        >             <div className="w-[400px] mx-auto bg-gray-100 p-5 rounded-2xl">
                <div className="heading text-gradient-to-r from-[rgb(49,80,148)] to-[rgb(9,9,174)]">Log In</div>
                ...
                <button className="login-button bg-gradient-to-r from-[rgb(5,1,77)] to-[rgb(9,9,174)]" type="submit" onClick={verifyCredentials} >
                    Sign In
                </button>
              ...
              0          <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"></path>
                        </svg>
                    </button>
                    </div>
                </div>
                <span className="agreement"> <Link to={`/signup`}>Dont have a account, Create now</Link></span>
            </div>
            </div>
